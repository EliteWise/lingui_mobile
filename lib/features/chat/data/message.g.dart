...
Message _messageDeserialize(
  ...
  final object = Message(
    ...
    type: reader.readStringOrNull(offsets[6]) ?? 'text',
  );
  object.id = id;
  return object;
}
...
extension MessageQueryWhereSort on QueryBuilder<Message, Message, QWhere> {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anySenderId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anyReceiverId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension MessageQueryWhere on QueryBuilder<Message, Message, QWhereClause> {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> senderIdGreaterThan(
    String senderId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> senderIdLessThan(
    String senderId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> senderIdBetween(
    String lowerSenderId,
    String upperSenderId, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> senderIdStartsWith(
      String SenderIdPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'senderId',
        lower: [SenderIdPrefix],
        upper: ['$SenderIdPrefix\u{FFFFF}'],
      ));
    });
  }

  QueryBuilder<Message, Message, QAfterWhereClause> senderIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'senderId',
        value: [''],
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> senderIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdGreaterThan(
    String receiverId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdLessThan(
    String receiverId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdBetween(
    String lowerReceiverId,
    String upperReceiverId, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdStartsWith(
      String ReceiverIdPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'receiverId',
        lower: [ReceiverIdPrefix],
        upper: ['$ReceiverIdPrefix\u{FFFFF}'],
      ));
    });
  }

  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'receiverId',
        value: [''],
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> receiverIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.lessThan(
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> attachmentsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> attachmentsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByAttachments() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, List<String>?, QQueryOperations> attachmentsProperty() {
    return QueryBuilder.apply(this, (query) {
